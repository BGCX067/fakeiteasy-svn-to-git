namespace FakeItEasy.Tests.Api
{
    ...
    public class MethodInfoManagerTests
    {
        ...
        [Test]
        public void WillInvokeSameMethodOnTarget_should_be_null_guarded()
        {
            var method = this.GetMethod<BaseType>(x => x.DoSomething());
            var manager = this.CreateManager();
            NullGuardedConstraint.Assert(() =>
                manager.WillInvokeSameMethodOnTarget(typeof(BaseType), method, method));
        }
