...
namespace FakeItEasy.Tests.Assertion
{
    ...
    public class FakeAssertionsTests
    {
        ...
        private LambdaExpression argumentToCallMatcherFactory;
        ...
        {
            this.argumentToCallMatcherFactory = null;
        ...
        public void WasCalled_should_call_matcher_factory_with_expression()
        {
            ...
            Assert.That(this.argumentToCallMatcherFactory, Is.EqualTo(expression));
        }
        ...
        //{
        //    // Arrange
        //    Fake.Configure(this.matcher).CallsTo(x => x.ToString()).Returns("description");
