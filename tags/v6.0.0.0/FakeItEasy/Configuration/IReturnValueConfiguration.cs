namespace FakeItEasy.Configuration
{
          ...
          ICallBaseConfiguration<TFake>
    {
        ...
        IAfterCallSpecifiedWithOutAndRefParametersConfiguration<TFake> Returns(TMember value);
        ...
        /// <returns>A configuration object.</returns>
        IAfterCallSpecifiedWithOutAndRefParametersConfiguration<TFake> Returns(Func<TMember> valueProducer);
        ...
        /// <param name="valueProducer">A function that produces the return value.</param>
        /// <returns>A configuration object.</returns>
        IAfterCallSpecifiedWithOutAndRefParametersConfiguration<TFake> Returns(Func<IFakeObjectCall, TMember> valueProducer);
    }
}