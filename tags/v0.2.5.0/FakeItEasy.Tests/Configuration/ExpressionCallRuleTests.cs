...
namespace FakeItEasy.Configuration.Tests
{
    [TestFixture]
    public class ExpressionCallRuleTests 
    {
        ...
        public void ToString_should_return_string_with_name_of_the_method_when_no_arguments()
        {
            ...
            Assert.That(rule.ToString(), Is.EqualTo("FakeItEasy.Tests.IFoo.Bar()"));
        }
        ...
        public void ToString_should_return_string_with_each_argument_as_string()
        {
            ...
            Assert.That(rule.ToString(), Is.EqualTo("FakeItEasy.Tests.IFoo.Bar([System.Object] 123, [System.Object] abc)"));
        ...
        public void ToString_should_return_string_with_name_of_the_property()
        {
            ...
            Assert.That(rule.ToString(), Is.EqualTo("FakeItEasy.Tests.IFoo.SomeProperty"));
        }
        ...
        public void ToString_should_write_NULL_for_null_arguments()
        {
            ...
            Assert.That(rule.ToString(), Is.EqualTo("FakeItEasy.Tests.IFoo.Bar([System.Object] <NULL>)"));
        }
        ...
        public void ToString_should_write_ANY_and_type_for_argument_validator_ANY()
        {
            ...
            Assert.That(rule.ToString(), Is.EqualTo("FakeItEasy.Tests.IFoo.Bar([System.Object] <Any System.String>)"));
        }
