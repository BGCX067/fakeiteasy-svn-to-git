...
namespace Legend.Fakes.Api
{
    ...
    {
        [Serializable]
        [SuppressMessage("Microsoft.Design", "CA1001:TypesThatOwnDisposableFieldsShouldBeDisposable", Justification = "The EventHandlerList implements IDisposable wrong.")]
