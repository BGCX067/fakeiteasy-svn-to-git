namespace FakeItEasy.DynamicProxy
{
    ...
    internal class DynamicProxyProxyGenerator
         : IProxyGeneratorWithMultipleInterfaceSupport
    {
        ...
        public void AddInterfaceToProxy(Type interfaceType, object proxy)
        {
            ...
            proxyGenerator.ProxyBuilder.CreateClassProxy(
            var result = proxyGenerator.CreateInterfaceProxyWithTarget(interfaceType, proxy, CreateFakeObjectInterceptor(Fake.GetFakeObject(proxy)));
