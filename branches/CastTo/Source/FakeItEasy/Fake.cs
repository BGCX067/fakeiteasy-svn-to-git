namespace FakeItEasy
{
    ...
    public static partial class Fake
    {
        ...
        /// </summary>
        /// <param name="interfaceType">The type of interface to cast to.</param>
        ...
        public static void CastTo(Type interfaceType, object fakedObject)
        {
            Guard.IsNotNull(interfaceType, "interfaceType");
            Guard.IsNotNull(fakedObject, "fakedObject");

            var manager = ServiceLocator.Current.Resolve<IFakeCastManager>();
            manager.CastTo(interfaceType, fakedObject);
        }
