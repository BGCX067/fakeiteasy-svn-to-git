...
namespace FakeItEasy {
    ...
    internal class ExceptionMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The current IProxyGenerator does not support multiple interfaces per fake..
        /// </summary>
        internal static string ProxyGeneratorDoesNotSupportMultipleInterfaces {
            get {
                return ResourceManager.GetString("ProxyGeneratorDoesNotSupportMultipleInterfaces", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The specified type is not an interface type..
        /// </summary>
        internal static string TypeIsNotInterfaceType {
            get {
                return ResourceManager.GetString("TypeIsNotInterfaceType", resourceCulture);
            }
        }
