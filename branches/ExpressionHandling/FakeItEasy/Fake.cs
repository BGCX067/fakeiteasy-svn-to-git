namespace FakeItEasy
{
    ...
    public static class Fake
    {
        ...
        public static IFakeConfiguration<TFake> Configure<TFake>(TFake fakedObject)
        {
            ...
            var expressionCallRuleFactory = ServiceLocator.Current.Resolve<ExpressionCallRule.Factory>();
            return new FakeConfiguration<TFake>(Fake.GetFakeObject(fakedObject), expressionCallRuleFactory);
        }
        ...
        /// <exception cref="ArgumentException">The object passed in is not a faked object.</exception>
        public static CallCollection<TFake> GetCalls<TFake>(TFake fakedObject)
        {
            Guard.IsNotNull(fakedObject, "fakedObject");
        ...
        {
            return ServiceLocator.Current.Resolve<FakeObjectFactory.Creator>().Invoke();
        }
    }
}