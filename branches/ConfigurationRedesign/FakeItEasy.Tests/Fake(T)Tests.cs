...
namespace FakeItEasy.Tests
{
        ...
        : ConfigurableServiceLocatorTestBase
    {
        ...
        public void RecordedCalls_returns_call_collection_from_factory()
        {
            ...
            A.CallTo(() => factory.CreateCallCollection<IFoo>(fakeObject)).Returns(collectionReturnedFromFactory);
        ...
        public void Calls_to_returns_fake_configuration_for_the_faked_object_when_void_call_is_specified()
        {
            ...
            IVoidConfiguration voidConfiguration = fake.CallsTo(x => x.Bar()) as FakeConfiguration;
            var configuration = voidConfiguration as FakeConfiguration;
        ...
        public void Calls_to_returns_fake_configuraion_for_the_faked_object_when_function_call_is_specified()
        {
            ...
            IReturnValueConfiguration<int> returnValueConfiguration = fake.CallsTo(x => x.Baz());
            var configuration = returnValueConfiguration as FakeConfiguration.ReturnValueConfiguration<int>;
        ...
        public void AnyCall_returns_fake_configuration_for_the_faked_object()
        {
            ...
            IVoidConfiguration voidConfiguration = fake.AnyCall();
            var configuration = voidConfiguration as FakeConfiguration;
