...
using FakeItEasy.Assertion;
    ...
    public class RuleBuilderTests
    {
        ...
        [Test]
        public void MustHaveHappened_with_void_call_should_assert_on_assertions_produced_by_factory()
        {
            // Arrange
            ...
            Fake.Assert(this.asserter)
                .WasCalled(x => x.AssertWasCalled(A<Func<IFakeObjectCall, bool>>.Ignored, "call description", repeatMatcher, "the number of times specified by the predicate 'x => (x = 99)'"));
        }

        [Test]
        public void MustHaveHappened_with_void_call_should_remove_built_rule_from_fake_object()
        {
            // Arrange
        ...
        [Test]
        public void MustHaveHappened_with_function_call_should_remove_built_rule_from_fake_object()
        {
            // Arrange
            this.fakeObject.AddRule(this.ruleProducedByFactory);
            ...
            // Act
            var returnConfig = new RuleBuilder.ReturnValueConfiguration<int>() { ParentConfiguration = this.builder };
            returnConfig.MustHaveHappened(x => true);
