...
namespace FakeItEasy.Tests.DynamicProxy
{
    ...
    public class InvocationCallAdapterTests
    {
        ...
        public void CallBaseMethod_should_call_Proceed_on_invokation()
        {
            ...
            Configure.Fake(invokation).CallsTo(x => x.Arguments).Returns(new object[] { });
            Configure.Fake(invokation).CallsTo(x => x.Method).Returns(typeof(IFoo).GetMethod("Bar", new Type[] { }));
