namespace FakeItEasy
{
    ...
    public static class A
    {
        ...
        public static IVoidArgumentValidationConfiguration CallTo(Expression<Action> callSpecification)
        {
            ...
            return ConfigurationFactory.CreateConfiguration(fakeObject, rule);
        }
        ...
        private static IConfigurationFactory ConfigurationFactory
        {
            get
            {
                return ServiceLocator.Current.Resolve<IConfigurationFactory>();
            }
        }

        private static ExpressionCallRule CreateRuleFromCallSpecification(LambdaExpression callSpecification)
        {
            var ruleFactory = ServiceLocator.Current.Resolve<ExpressionCallRule.Factory>();
            return ruleFactory.Invoke(callSpecification);
        }
        ...
        public static void CallTo(Func<EventHandler> func)
        {
    ...
    public class A<T>
    {
        ...
        /// </summary>
        public static ArgumentValidations<T> That
        {
            get
            {
