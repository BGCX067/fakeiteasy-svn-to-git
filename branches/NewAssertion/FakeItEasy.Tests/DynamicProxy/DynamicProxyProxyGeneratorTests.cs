    ...
    public class DynamicProxyProxyGeneratorTests
    {
        ...
        public void TryGenerateProxy_without_arguments_for_constructor_should_return_true_when_container_can_resolve_arguments_for_constructor()
        {
            Configure.Fake(this.container)
                .CallsTo(x => x.TryCreateFakeObject(typeof(string), out Null<object>.Out))
                .Returns(true)
        ...
        [Test]
        public void TryGenerateProxy_without_arguments_for_constructor_should_generate_proxy_when_constructor_argument_is_class_with_default_constructor()
        {
            var generator = this.CreateGenerator();

            ProxyResult result;
            var generated = generator.TryGenerateProxy(typeof(SealedTypeThatTakesClassWithDefaultConstructorInConstructor), this.fakeObject, this.container, out result);
        ...
        [Test]
        public void TryGenerateProxy_should_return_false_when_resolvable_constructors_contains_circular_dependencies()
        {
            var generator = this.CreateGenerator();
            var generated = generator.TryGenerateProxy(typeof(CircularClassA), this.fakeObject, this.container, out Null<ProxyResult>.Out);

            Assert.That(generated, Is.False);
        }

        [Test]
        public void TryGenerateProxy_should_use_widest_fakeable_constructor()
        {
            var generator = this.CreateGenerator();
            ProxyResult result;
            generator.TryGenerateProxy(typeof(ClassWithDefaultConstructorAndResolvableConstructor), this.fakeObject, this.container, out result);
        ...
        [Test]
        public void TryGenerateProxy_should_return_false_when_resolved_constructor_throws_exception()
        {
            var generator = this.CreateGenerator();
            
            ProxyResult result;
            var generated = generator.TryGenerateProxy(typeof(TypeWithConstructorThatThrows), this.fakeObject, this.container, out result);

            Assert.That(generated, Is.False);
        }

        [Test]
        public void TryGenerateProxy_should_return_true_when_type_has_constructor_that_does_not_throw()
        {
            var generator = this.CreateGenerator();

            ProxyResult result;
            var generated = generator.TryGenerateProxy(typeof(TypeWithConstructorThatThrowsAndConstructorThatDoesNotThrow), this.fakeObject, this.container, out result);
