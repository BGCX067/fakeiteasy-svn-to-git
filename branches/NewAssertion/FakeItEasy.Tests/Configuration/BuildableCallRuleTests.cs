...
namespace FakeItEasy.Tests.Configuration
{
    ...
    public class BuildableCallRuleTests
    {
        ...
        [Test]
        public void IsApplicableTo_should_return_false_when_no_applicator_has_been_set()
        {
            // Arrange
            var rule = this.CreateRule();
            
            // Act
            var result = rule.IsApplicableTo(A.Fake<IFakeObjectCall>());
        ...
        [Test]
        public void IsApplicableTo_should_return_true_when_applicator_has_been_set()
        {
            // Arrange
            var rule = this.CreateRule();
            rule.Applicator = x => { };
