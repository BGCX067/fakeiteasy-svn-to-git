...
namespace FakeItEasy {
    ...
    internal class ExceptionMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Can not create fake of the type &apos;FakeItEasy.Tests.IFoo&apos;, it&apos;s not registered in the current container and the current IProxyGenerator can not generate the fake..
        /// </summary>
