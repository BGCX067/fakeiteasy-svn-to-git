...
namespace FakeItEasy
{
    ...
    public static class A
    {
        ...
        {
            var fakeObject = new FakeObject(typeof(T));
            fakeObject.AddRule(new PersisterRule { Recorder = persister, WrappedObjectRule = new WrappedObjectRule(wrappedInstance) });
            return (T)fakeObject.Object;
        }
    ...
    public interface IFakeCallRecorder
        : IDisposable
    {
    ...
    public class PersisterRule
        : IFakeObjectCallRule
    {
        public IFakeCallRecorder Recorder;
        public WrappedObjectRule WrappedObjectRule;
